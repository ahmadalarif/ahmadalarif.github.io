!function (e, t) {
        ...
        , J = e => {
            ...
            for (const n in e)
                t = n,
                    ...
                    e.toast && (t = n,
                        _.includes(t) && a('The parameter "'.concat(t, '" is incompatible with toasts'))),
                    t = n,
                    Z(t) && N(t, Z(t));
            var t
        }
    ...
    const c = {
        ...
        , Ae = () => {
            const e = m();
            return !!e && (e.remove(),
                A([document.documentElement, document.body], [p["no-backdrop"], p["toast-shown"], p["has-column"]]),
                !0)
        }
        , S = () => {
        ...
        , Oe = (e, t) => {
            ...
            (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? B : x)(s),
                C(s, t, "actions"),
                s = s,
                n = c,
                o = t,
    ...
    const Me = (e, t) => {
        var n, o, i = m();
        i && (o = i,
            "string" == typeof (n = t.backdrop) ? o.style.background = n : n || k([document.documentElement, document.body], p["no-backdrop"]),
            o = i,
            (n = t.position) in p ? k(o, p[n]) : (a('The "position" parameter is not valid, defaulting to "center"'),
                k(o, p.center)),
            n = i,
            (o = t.grow) && "string" == typeof o && (o = "grow-".concat(o)) in p && k(n, p[o]),
            C(i, t, "container"))
    }
        ;
    var L = {
    ...
    const De = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
        , He = (e, r) => {
            ...
            De.forEach(e => {
                ...
                r.input && (c && (e => {
                    ...
                    e = r,
                    t = Ne(e.input),
                    e.customClass && k(t, e.customClass.input))
        }
        , Ie = t => {
        ...
        , O = {}
        , Re = (O.text = O.email = O.password = O.number = O.tel = O.url = (e, t) => ("string" == typeof t.inputValue || "number" == typeof t.inputValue ? e.value = t.inputValue : U(t.inputValue) || a('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t.inputValue, '"')),
            Ve(e, e, t),
            qe(e, t),
            e.type = t.input,
            e),
            ...
            (e, t) => {
                ...
                C(n, t, "htmlContainer"),
                    t.html ? (Te(t.html, n),
                        B(n, "block")) : t.text ? (n.textContent = t.text,
                            B(n, "block")) : x(n),
                    He(e, t)
            }
        )
        ...
        , We = (e, t) => {
            var e = L.innerParams.get(e)
                , n = s();
            return e && t.icon === e.icon ? (Ze(n, t),
                void ze(n, t)) : t.icon || t.iconHtml ? t.icon && -1 === Object.keys(o).indexOf(t.icon) ? (l('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')),
                    x(n)) : (B(n),
                        Ze(n, t),
                        ze(n, t),
                        void k(n, t.showClass.icon)) : x(n)
        }
        , ze = (e, t) => {
            for (const n in o)
                t.icon !== n && A(e, o[n]);
        ...
        , Ze = (e, t) => {
            var n;
            e.textContent = "",
                t.iconHtml ? v(e, Xe(t.iconHtml)) : "success" === t.icon ? v(e, Ke) : "error" === t.icon ? v(e, Ye) : (n = {
                    question: "?",
                    warning: "!",
                    info: "i"
                },
        ...
        , Ge = (e, o) => {
            ...
            B(i),
                ...
                o.progressSteps.forEach((e, t) => {
                    ...
                    var n, e = n;
                    i.appendChild(e),
                        t === o.currentProgressStep && k(e, p["active-progress-step"]),
                        t !== o.progressSteps.length - 1 && (n = (e => {
                            const t = document.createElement("li");
                            return k(t, p["progress-step-line"]),
        ...
        , et = (e, t) => {
            var n = m();
            const o = g();
            t.toast ? (pe(n, "width", t.width),
                o.style.width = "100%",
                o.insertBefore(d(), s())) : pe(o, "width", t.width),
                pe(o, "padding", t.padding),
                t.color && (o.style.color = t.color),
                t.background && (o.style.background = t.background),
                x(ee());
            n = o;
            (n.className = "".concat(p.popup, " ").concat(E(n) ? t.showClass.popup : ""),
                t.toast) ? (k([document.documentElement, document.body], p["toast-shown"]),
                    k(n, p.toast)) : k(n, p.modal);
            C(n, t, "popup"),
                "string" == typeof t.customClass && k(n, t.customClass);
        ...
        , st = e => {
            ...
            return n && (M(n, ["src", "width", "height", "alt"]),
        ...
        , lt = e => {
            ...
            t && (M(t, ["type", "label", "placeholder", "value"]),
    ...
    const ht = () => {
        null === c.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (c.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
            document.body.style.paddingRight = "".concat(c.previousBodyPadding + (() => {
        ...
        , ft = () => {
            null !== c.previousBodyPadding && (document.body.style.paddingRight = "".concat(c.previousBodyPadding, "px"),
        ...
        , vt = () => {
            var e;
            w(document.body, p.iosfix) && (e = parseInt(document.body.style.top, 10),
        ...
        , Ct = e => {
            ...
            if (e.target === t) {
                const n = m();
                t.removeEventListener(Le, Ct),
                    n.style.overflowY = "auto"
            }
        }
        , kt = (e, t) => {
            Le && be(t) ? (e.style.overflowY = "hidden",
                t.addEventListener(Le, Ct)) : e.style.overflowY = "auto"
        }
        , At = (e, t, n) => {
            bt(),
                t && "hidden" !== n && ht(),
        ...
        , Pt = (e, t, n) => {
            k(e, n.showClass.backdrop),
                ...
                setTimeout(() => {
                    ...
                    , wt),
                k([document.documentElement, document.body], p.shown),
                n.heightAuto && n.backdrop && !n.toast && k([document.documentElement, document.body], p["height-auto"])
        }
        , D = e => {
            let t = g();
            t || new vn,
        ...
        , Bt = (t, n) => {
            ...
            F(n.inputOptions) || U(n.inputOptions) ? (D(h()),
        ...
        , Tt = n => {
            ...
            return "undefined" != typeof Map && n instanceof Map ? n.forEach((e, t) => {
                let n = e;
                "object" == typeof n && (n = Tt(n)),
                    o.push([t, n])
            }
            ) : Object.keys(n).forEach(e => {
                let t = n[e];
                "object" == typeof t && (t = Tt(t)),
                    o.push([e, t])
            }
            ),
                o
    ...
    function Lt () {
        ...
        if (t) {
            ...
            x(n.loader),
                re() ? t.icon && B(s()) : (t = n,
                    (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? B(e[0], "inline-block") : he() && x(t.actions)),
    ...
    function jt (e, t, n, o) {
        re() ? It(e, o) : (Ce(n).then(() => It(e, o)),
            ...
            ae() && (ft(),
                vt(),
                ot()),
            A([document.documentElement, document.body], [p.shown, p["height-auto"], p["no-backdrop"], p["toast-shown"]])
    }
    function Mt (e) {
        ...
        this.isAwaitingPromise() ? e.isDismissed || (Dt(this),
            t(e)) : n && t(e)
    }
    const Dt = e => {
        e.isAwaitingPromise() && (L.awaitingPromise.delete(e),
            L.innerParams.get(e) || e._destroy())
    }
        , Ht = (e, t, n) => {
            var o, i, a, r = m(), s = Le && be(t);
            "function" == typeof n.willClose && n.willClose(t),
                s ? (s = e,
                    ...
                    i = n.returnFocus,
                    a = n.didClose,
                    T.swalCloseEventFinishedCallback = jt.bind(null, s, t, i, a),
                    o.addEventListener(Le, function (e) {
                        e.target === o && (T.swalCloseEventFinishedCallback(),
    ...
    const Nt = e => {
        e.isAwaitingPromise() ? (Rt(L, e),
            L.awaitingPromise.set(e, !0)) : (Rt(Ot, e),
                Rt(L, e))
    }
        , Rt = (e, t) => {
            for (const n in e)
    ...
    e = Object.freeze({
        ...
        _destroy: function () {
            ...
            t ? (e.popup && T.swalCloseEventFinishedCallback && (T.swalCloseEventFinishedCallback(),
                delete T.swalCloseEventFinishedCallback),
                ...
                delete T.currentInstance) : Nt(this)
        }
    });
    const Ft = (e, t) => {
        ...
        if (n.inputValidator) {
            ...
            const s = L.innerParams.get(i)
                , c = (i.disableInput(),
                    Promise.resolve().then(() => u(s.inputValidator(a, s.validationMessage))));
            c.then(e => {
                i.enableButtons(),
                    i.enableInput(),
                    e ? i.showValidationMessage(e) : ("deny" === r ? Ut : _t)(i, a)
            }
            )
        } else
            e.getInput().checkValidity() ? ("deny" === t ? Ut : _t)(e, o) : (e.enableButtons(),
                e.showValidationMessage(n.validationMessage))
    }
        , Ut = (t, n) => {
            const e = L.innerParams.get(t || void 0);
            if (e.showLoaderOnDeny && D(f()),
                e.preDeny) {
        ...
        , _t = (t, n) => {
            const e = L.innerParams.get(t || void 0);
            if (e.showLoaderOnConfirm && D(),
                e.preConfirm) {
                t.resetValidationMessage(),
                    L.awaitingPromise.set(t || void 0, !0);
                const o = Promise.resolve().then(() => u(e.preConfirm(n, e.validationMessage)));
                o.then(e => {
                    E(ee()) || !1 === e ? (t.hideLoading(),
                        Dt(t)) : Wt(t, void 0 === e ? n : e)
                }
                ).catch(e => zt(t || void 0, e))
            } else
                Wt(t, n)
            ...
            t.container.onmousedown = () => {
                t.popup.onmouseup = function (e) {
                    t.popup.onmouseup = void 0,
                        e.target !== t.popup && !t.popup.contains(e.target) || (Yt = !0)
                }
            }
        }
        , Xt = (n, o, i) => {
            ...
            if (o && (!n.isComposing && 229 !== n.keyCode))
                if (o.stopKeydownPropagation && n.stopPropagation(),
                    ...
                    e = e,
                        s = n,
                        i = o,
                        R(i.allowEnterKey) && s.target && e.getInput() && s.target.outerHTML === e.getInput().outerHTML && (["textarea", "file"].includes(i.input) || ($t(),
                            s.preventDefault()));
                else if ("Tab" === n.key) {
                    e = n;
                    var i = o;
                    ...
                    if ([l, u, d].includes(document.activeElement)) {
                        ...
                        for (let e = 0; e < y().children.length; e++) {
                            if (!(t = t[c]))
                                return;
                            if (E(t) && t instanceof HTMLButtonElement)
                                break
                        }
    ...
    var un = Object.freeze({
        ...
        bindClickHandler: function () {
            ...
            cn[e] = this,
                sn || (document.body.addEventListener("click", ln),
                    sn = !0)
        }
    });
    let dn;
    ...
    const pn = (l, u, d) => new Promise((e, t) => {
        ...
        Ot.swalPromiseResolve.set(l, e),
            ...
            u.denyButton.onclick = () => {
                var e = l
                    , t = L.innerParams.get(e);
                e.disableButtons(),
                    t.returnInputValueOnDeny ? Ft(e, "deny") : Ut(e, !1)
            }
            ,
            ...
            t = u,
            a = n,
            L.innerParams.get(e).toast ? Kt(e, t, a) : (Zt(t),
                Jt(t),
                Xt(e, t, a)),
            o = l,
            e = T,
            ...
            t.toast || (e.keydownHandler = e => tn(o, e, i),
            ...
            a = l,
            "select" === (t = d).input || "radio" === t.input ? Bt(a, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (F(t.inputValue) || U(t.inputValue)) && (D(h()),
                xt(a, t));
        {
            var r = d;
            const s = m()
            ...
            "function" == typeof r.willOpen && r.willOpen(c),
                ...
                setTimeout(() => {
                    ...
                    , wt),
                ae() && (At(s, r.scrollbarPadding, e),
                    nt()),
                re() || T.previousActiveElement || (T.previousActiveElement = document.activeElement),
        ...
        , mn = (e, t) => {
            ...
            return o.showClass = Object.assign({}, r.showClass, o.showClass),
        ...
        , fn = (e, t) => {
            if (!t.toast)
                return R(t.allowEnterKey) ? void (bn(e, t) || Gt(t, -1, 1)) : yn()
        }
        , bn = (e, t) => t.focusDeny && E(e.denyButton) ? (e.denyButton.focus(),
            !0) : t.focusCancel && E(e.cancelButton) ? (e.cancelButton.focus(),
                !0) : !(!t.focusConfirm || !E(e.confirmButton)) && (e.confirmButton.focus(),
                    !0)
        , yn = () => {
            document.activeElement instanceof HTMLElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()
        }
        , vn = (Object.assign(H.prototype, e),
            Object.assign(H, un),
            Object.keys(e).forEach(e => {
                H[e] = function () {
                    if (dn)
                        return dn[e](...arguments)
                }
            }
            ),
            H.DismissReason = j,
